...
This guide documents the prerequisites, installation steps, and test queries to run the Autonomous Research Agent (Assignment 6).
...
Ensure you are in the root project directory (`assignment-6/`):
```bash
cd /Users/mahipal/Desktop/My_Plugins/assignment-6
```
