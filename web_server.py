...
def clean_state():
    """Clear memory.json and history.json files."""
    try:
        MEMORY_PATH.write_text("[]", encoding="utf-8")
        HISTORY_PATH.write_text("[]", encoding="utf-8")
